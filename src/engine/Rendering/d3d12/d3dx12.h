...
struct CD3DX12_PIPELINE_STATE_STREAM2
{
    ...
    D3D12_GRAPHICS_PIPELINE_STATE_DESC GraphicsDescV0() const noexcept
    {
        ...
        D.NumRenderTargets = D3D12_RT_FORMAT_ARRAY(
            this->RTVFormats
        ).NumRenderTargets;
        memcpy(D.RTVFormats, D3D12_RT_FORMAT_ARRAY(
            this->RTVFormats
        ).RTFormats, sizeof(D.RTVFormats));
...
struct CD3DX12_PIPELINE_MESH_STATE_STREAM
{
    ...
    D3DX12_MESH_SHADER_PIPELINE_STATE_DESC MeshShaderDescV0() const noexcept
    {
        ...
        D.MS = this->MS;
        D.BlendState = this->BlendState;
        D.DepthStencilState = CD3DX12_DEPTH_STENCIL_DESC1(D3D12_DEPTH_STENCIL_DESC1(
